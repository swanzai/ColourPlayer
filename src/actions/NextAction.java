...
public class NextAction extends ButtonAction {
    ...
    public NextAction(Button button, Player player, PlaylistDao playlist, PlayAction playAction) throws MalformedURLException {
        super(button);
        this.player = player;
    ...
    public void run() {
        if (playlist.nextTrack()) {
            System.out.println("Has next track");
