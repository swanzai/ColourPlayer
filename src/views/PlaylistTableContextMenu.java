...
public class PlaylistTableContextMenu {
    private Menu menu;
    ...
    public PlaylistTableContextMenu(Shell shell, Table table, GlazedDatabaseDao dao,
    ...
    public void initItems(EventList<Track> eventList) {
        ...
        itemMap.put("removeFromPlaylist", removeFromPlaylist = new MenuItem(
                menu, SWT.PUSH));
        removeFromPlaylist.setText("Remove from playlist");
        removeFromPlaylist.addListener(SWT.Selection,
                new RemoveFromPlaylistAction(table, nowPlaying, eventList));

        itemMap.put("clearPlaylist", clearPlaylist = new MenuItem(menu,
                SWT.PUSH));
        clearPlaylist.setText("Clear playlist");
        clearPlaylist.addListener(SWT.Selection, new ClearPlaylistAction(nowPlaying));
